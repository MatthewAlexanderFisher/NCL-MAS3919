...
The model begins by analysing the provided text to understand its structure and content; this likely involves the use of a large language model (LLM), and we will discuss these in @sec-text-data.
...
A discussion of how to solve such optimisation problems numerically is deferred to @def-adversarial-attacksec-stoch-opt.
