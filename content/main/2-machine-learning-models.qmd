...
$$
\nabla_{\bm{\theta}}^2 [ \mathcal{R}_n(f_{\bm{\theta}}) + \lambda_n R(\bm{\theta}) ] = 2 \left( \frac{1}{n} \bm{\Phi}^\top \bm{\Phi} + \lambda_n \mathbf{I} \right) , 
$$
...
![Top:  The parameters $\bm{\theta}$ learned by (a) ridge regression, and (b) the LASSO, each as a function of the regularisation strength $\lambda$. Bottom:  The fitted models for varying $\lambda$.](figures/ridge_lasso_results.png){#fig-ridge-coeff width=70%}
